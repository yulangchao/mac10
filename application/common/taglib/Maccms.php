...
class Maccms extends Taglib {
	...
	protected $tags = [
        ...
        'type' => ['attr' =>'order,by,start,num,id,ids,parent,flag,mid,format'],
        'comment'=>['attr' =>'order,by,start,num,paging,id,pid,rid,mid,half'],
        'gbook'=>['attr' =>'order,by,start,num,paging,rid,half'],
        'role'=>['attr' =>'order,by,start,num,paging,id,ids,not,rid,actor,level,letter,half,timeadd,timehits,time'],
        'actor'=>['attr' =>'order,by,start,num,paging,id,ids,not,area,sex,level,letter,half,timeadd,timehits,time'],
        'topic' => ['attr' =>'order,by,start,num,id,ids,not,paging,class,tag,half,timeadd,timehits,time'],
        'art' => ['attr' =>'order,by,start,num,id,ids,not,paging,pageurl,type,class,tag,level,letter,half,rel,timeadd,timehits,time,hitsmonth,hitsweek,hitsday,hits'],
        'vod' => ['attr' =>'order,by,start,num,id,ids,not,paging,pageurl,type,class,tag,area,lang,year,level,letter,half,rel,version,state,tv,weekday,timeadd,timehits,time,hitsmonth,hitsweek,hitsday,hits'],
