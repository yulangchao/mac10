...
class Paycodepay extends Base {
    ...
    public function submit($user,$order,$param)
    {
        ...
        $data = array(
            ...
            "notify_url" => 'http://' . $_SERVER['SERVER_NAME'] . '/index.php/payment/notify/pay_type/codepay',//通知地址
            "return_url" => 'http://' . $_SERVER['SERVER_NAME'] . '/index.php/payment/notify/pay_type/codepay',//跳转地址
            "debug" => 1,//软件未启动的话
