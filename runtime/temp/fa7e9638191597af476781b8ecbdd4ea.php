<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:40:"template/default_pc/html/vod\detail.html";i:1528206599;s:89:"C:\workplace\Document\Richard\template\temp8\template\default_pc\html\public\include.html";i:1522757228;s:86:"C:\workplace\Document\Richard\template\temp8\template\default_pc\html\public\head.html";i:1528596157;s:87:"C:\workplace\Document\Richard\template\temp8\template\default_pc\html\public\star2.html";i:1518097631;s:86:"C:\workplace\Document\Richard\template\temp8\template\default_pc\html\public\foot.html";i:1526388993;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="header">
    ...
    <div id="searchbar">
        ...
        <div class="hotkeys">热搜：
            <?php $_5b1f0c0b5f299=explode(',',$maccms['search_hot']); if(is_array($_5b1f0c0b5f299) || $_5b1f0c0b5f299 instanceof \think\Collection || $_5b1f0c0b5f299 instanceof \think\Paginator): if( count($_5b1f0c0b5f299)==0 ) : echo "" ;else: foreach($_5b1f0c0b5f299 as $key2=>$vo2): ?>
...
<div class="ui-box marg">
    ...
    <div class="box_con">
        <ul class="img-list dis">
            <?php $__TAG__ = '{"num":"6","type":"current","order":"desc","by":"time"}';$__LIST__ = model("Vod")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
...
<div class="ui-box marg">
    ...
    <div class="box_con">
        <ul class="img-list dis">
            <?php $__TAG__ = '{"num":"6","ids":"'.$obj['vod_rel_vod'].'","order":"desc","by":"time"}';$__LIST__ = model("Vod")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
            <li><a href="<?php echo mac_url_vod_detail($vo); ?>" title="<?php echo $vo['vod_name']; ?>"><img src="<?php echo mac_url_img($vo['vod_pic']); ?>" alt="<?php echo $vo['vod_name']; ?>"/><h2><?php echo $vo['vod_name']; ?></h2><p></p><i><?php echo $vo['vod_version']; ?></i><em></em></a></li>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
    </div>
