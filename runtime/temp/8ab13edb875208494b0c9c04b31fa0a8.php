<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"C:\workplace\Document\Richard\template\temp8/application/admin\view\timming\index.html";i:1526990119;s:84:"C:\workplace\Document\Richard\template\temp8\application\admin\view\public\head.html";i:1522563358;s:84:"C:\workplace\Document\Richard\template\temp8\application\admin\view\public\foot.html";i:1526046066;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <form class="layui-form " method="post" id="pageListForm">
        <table class="layui-table" lay-size="sm">
            ...
            <tr>
                ...
                <td>
                    <a class="layui-badge-rim" target="_blank" href="<?php echo $maccms['path']; ?>/api.php/timming/index?name=<?php echo $vo['name']; ?>" title="测试">测试</a>
                    <a class="layui-badge-rim j-iframe" data-href="<?php echo url('info?id='.$vo['name']); ?>" href="javascript:;" title="编辑">编辑</a>
                    <a class="layui-badge-rim j-tr-del" data-href="<?php echo url('del?ids='.$vo['name']); ?>" href="javascript:;" title="删除">删除</a>
                </td>
            </tr>
