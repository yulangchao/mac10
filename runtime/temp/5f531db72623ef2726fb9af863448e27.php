<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:92:"C:\workplace\Document\Richard\template\temp8/application/admin\view\system\configweixin.html";i:1521027568;s:84:"C:\workplace\Document\Richard\template\temp8\application\admin\view\public\head.html";i:1522563358;s:84:"C:\workplace\Document\Richard\template\temp8\application\admin\view\public\foot.html";i:1526046066;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-tab">
            ...
            <div class="layui-tab-item layui-show">
                <blockquote class="layui-elem-quote layui-quote-nm">
                    公众号对接域名、公众号搜索域名、网站域名通常一致，因公众号可能产生的封域名问题，你可以单独设置域名进行对接。全部都不要加http://<br>
                    接口地址/api.php/wechat
                </blockquote>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="weixin[duijie]" placeholder="公众号后台的对接地址为【http://wx.maccms.com/inc/weixin.php】" value="<?php echo $config['weixin']['duijie']; ?>" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">搜索域名：</label>
                    <div class="layui-input-block">
                        <input type="text" name="weixin[sousuo]" placeholder="用来在公共号内显示的域名，一般红名更换此域名即可" value="<?php echo $config['weixin']['sousuo']; ?>" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="radio" name="weixin[bofang]" value="0" title="内容页面" <?php if($config['weixin']['bofang'] == 0): ?>checked <?php endif; ?>>
