...
<div class="header">
    ...
    <div id="searchbar">
        ...
        <div class="hotkeys">热搜：
            <?php $_5b1f0c0d12461=explode(',',$maccms['search_hot']); if(is_array($_5b1f0c0d12461) || $_5b1f0c0d12461 instanceof \think\Collection || $_5b1f0c0d12461 instanceof \think\Paginator): if( count($_5b1f0c0d12461)==0 ) : echo "" ;else: foreach($_5b1f0c0d12461 as $key2=>$vo2): ?>
...
<div class="bread-crumb-nav fn-clear">
    <ul class="bread-crumbs">
        ...
        <li class="back">
            <a href="javascript:;" onclick="MAC.Gbook.Report('编号【<?php echo $obj['vod_id']; ?>】名称【<?php echo $obj['vod_name']; ?>】不能观看请检查修复，页面地址' + location.href)">【报错】</a>
