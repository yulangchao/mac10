<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:93:"C:\workplace\Document\Richard\template\temp8/application/admin\view\system\configcollect.html";i:1528723147;s:84:"C:\workplace\Document\Richard\template\temp8\application\admin\view\public\head.html";i:1522563358;s:84:"C:\workplace\Document\Richard\template\temp8\application\admin\view\public\foot.html";i:1526046066;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="layui-tab-item">
                ...
                <div class="layui-tab-item">
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">入库重复规则：</label>
                        <div class="layui-input-block">
                            <input type="checkbox" lay-skin="primary" name="collect[actor][inrule][]" value="a" title="标题" checked disabled>
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">数据过滤：</label>
                        <div class="layui-input-block">
                            <textarea name="collect[actor][filter]" class="layui-textarea" placeholder="多个数据请用逗号分隔"><?php echo $config['collect']['art']['filter']; ?></textarea>
                        </div>
                    </div>
