<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"C:\workplace\Document\Richard\template\temp8/application/admin\view\system\configapi.html";i:1521027568;s:84:"C:\workplace\Document\Richard\template\temp8\application\admin\view\public\head.html";i:1522563358;s:84:"C:\workplace\Document\Richard\template\temp8\application\admin\view\public\foot.html";i:1526046066;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="layui-tab">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">
                        数据过滤参数：</label>
                    <div class="layui-input-block">
                        <input type="text" name="api[vod][datafilter]" placeholder="SQL查询条件例如 and vod_status=1" value="<?php echo $config['api']['vod']['datafilter']; ?>" class="layui-input">
                    </div>
                </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">
